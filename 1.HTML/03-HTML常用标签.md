...
是HTML文档中最常见的标签，默认情况下，文本在一个段落中会根据浏览器窗口的大小**自动换行**。
...
div   span    是没有语义的     是我们网页布局主要的**2个盒子**   想必你听过  css+div
...
**区别：**
 ...
 b  只是加粗        strong  除了可以**加粗还有 强调**的意思，  语义更强烈。
...
提倡：   尽量不使用 样式属性（CSS）。   <img src="media/sm.jpg" /> 
...
3. 如果当时没有确定链接目标时，通常将链接标签的href属性值定义为“#”(即href="#")，表示该链接暂时为一个**空链接**。
